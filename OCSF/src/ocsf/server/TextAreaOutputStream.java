...
public TextAreaOutputStream(JTextArea ta) throws IOException {
    this(ta,1000);
    }

public TextAreaOutputStream(JTextArea ta, int ml) throws IOException {
    if(ml<1) { throw new IOException("Maximum lines of "+ml+" in TextAreaOutputStream constructor is not permitted"); }
    textArea=ta;
    maxLines=ml;
