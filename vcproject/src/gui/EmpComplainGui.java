...
public class EmpComplainGui extends JPanel {
	...
	private void initialize(){
		...
		btnReturn = new JButton("Return");
		 ...
		 lblCustomerSupport.setBounds(279, 11, 274, 22);
		 ...
		 btnSubmit.setBounds(672, 518, 103, 30);
		 add(btnSubmit);
	...
	private void listners(){
		 btnSubmit.addActionListener(new ActionListener() {
			 	public void actionPerformed(ActionEvent arg0) {
			 		...
			 		empController.complainReplay(table.getValueAt(table.getSelectedRow(), 0),table.getValueAt(table.getSelectedRow(), 1),textField.getText(),textArea.getText());
	...
	private EmpComplainController getEmpComplainController() {
